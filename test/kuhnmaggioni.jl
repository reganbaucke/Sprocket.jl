...
function test_one()
   function build_problem()
      ...
      division = Sprocket.Point(Dict(xi => 16))
   ...
   my_criteria = Sprocket.Criteria(iterations=2)

   states = Sprocket.solve(KuhnMaggioni.Algorithm(division), my_prob, my_criteria)
...
function test_two()
   function build_problem()
      ...
      division = Sprocket.Point(Dict(xi => 40, lam => 40))
...
function test_four()
   ...
   function build_problem()
      ...
      division = Sprocket.Point(Dict(xi => 10))
   ...
   (my_prob, division) = build_problem()
   KuhnMaggioni.cartesian_product(division, my_prob.domain)
   my_criteria = Sprocket.Criteria(iterations=10)
